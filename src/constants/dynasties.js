...
export const DYNASTIES = [
  {
    ...
    overview: '上古时期是中医药的起源阶段。\n先民在与自然的斗争中，逐渐积累了用药经验，"神农尝百草"的传说正是这一时期的缩影。',
    figures: [
  ...
  },
  {
    ...
    heroImage: '朝代背景2.jpg',
    overview: '春秋战国时期诸子百家争鸣，医学理论开始系统化。\n《黄帝内经》成书于这一时期，奠定了中医学的理论基础，\n系统阐述阴阳五行、脏腑经络、病因病机等，\n与《伤寒杂病论》《神农本草经》并称中医四大经典。',
    figures: [
  ...
  },
  {
    ...
    heroImage: '伤寒杂病论.jpg',
    overview: '秦汉时期是中医理论体系形成的关键阶段。\n《黄帝内经》的成书标志着中医学理论体系的初步建立，奠定了中医学的理论基础。',
    figures: [
  ...
  },
  {
    ...
    period: '公元25年—220年',
    heroImage: '华佗.jpg',
    overview: '东汉末年，战乱频繁，疫病流行，却也催生了伟大的医学家。\n华佗精通外科，发明麻沸散，开创了全身麻醉手术的先河。',
    figures: [
  ...
  },
  {
    ...
    overview: '两晋时期医学注重实用与急救。\n葛洪《肘后备急方》记载了大量简便验廉的急救方与传染病治法，\n其中"青蒿一握绞汁"治疟的记载，为后世青蒿素的发现提供了古典依据。',
    figures: [
  ...
  },
  {
    ...
    period: '公元618年—907年',
    heroImage: '新修本草.jpg',
    overview: '唐代是中国传统医学发展的鼎盛时期。政治稳定、经济繁荣，促进了医学的全面进步。\n官方设立了完善的医学教育和管理机构，医学典籍大量编纂，对外交流频繁。',
    figures: [
  ...
  },
  {
    ...
    period: '公元960年—1279年',
    heroImage: '宋代医学.jpg',
    overview: '宋代官方高度重视医学教育与考核。\n王惟一主持铸造针灸铜人用于教学与考试，并撰《铜人腧穴针灸图经》，\n针灸学与本草学均有重要发展，太医局制度完善。',
    figures: [
  ...
  },
  {
    ...
    overview: '明代是中医药学的集大成时期。\n李时珍历时27年编写《本草纲目》，被誉为"东方药物巨典"，对世界医药学产生了深远影响。',
    figures: [
  ...
  },
  {
    ...
    overview: '清代温病学派成熟，与伤寒学派并立。\n叶天士创立卫气营血辨证，吴鞠通著《温病条辨》确立三焦辨证，\n对发热性、传染性疾病的辨证与方药有系统总结，影响至今。',
    figures: [
  ...
  },
  {
    ...
    overview: '新中国成立后，中医药事业得到国家高度重视。\n屠呦呦因发现青蒿素获得诺贝尔奖，使中医药在世界舞台绽放光彩。中西医结合成为新的发展方向。',
    figures: [
  ...
  },
  {
    ...
    period: '21世纪',
    heroImage: '现代食疗.jpg',
    overview: '当下，中医药正在与现代科技深度融合。\n人工智能辅助诊疗、大数据药物研发、互联网中医等新模式不断涌现，中医药文化的传承与创新并进。',
    figures: [],
    texts: [],
    achievements: [
